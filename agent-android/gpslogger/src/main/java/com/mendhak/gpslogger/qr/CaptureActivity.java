package com.mendhak.gpslogger.qr;
...
public class CaptureActivity extends Activity {
    ...
    private void findViewById() {
        ...
        scanRestart.setVisibility(View.INVISIBLE);
        ...
        scanRestart.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                if (barcodeScanned) {
                    ...
                    scanResult.setText(R.string.qr_scanning);
    ...
    private void startQrCamera() {
        ...
        final TranslateAnimation animation = new TranslateAnimation(Animation.RELATIVE_TO_PARENT, 0.0f, Animation.RELATIVE_TO_PARENT, 0.0f,
                Animation.RELATIVE_TO_PARENT, 0.0f, Animation.RELATIVE_TO_PARENT, 0.88f);
